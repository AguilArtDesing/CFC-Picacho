...
<body>
	...
	<div class="sidebar">
		...
		<div class="sidebar__nav-ref">
			<div class="nav__ref-box">
				<div class="ref__box-option"><a href="#" class="option" title="Galeria"><i class="fas fa-images"></i></a></div>
			...
			<div class="menu__box menu__box-first">
				<div class="box__nav">
					<div class="nav__container">
						...
						<div class="nav__item"><a href="#" class="nav__link">Galeria de Imagenes</a></div>
	...
	<div class="gallery">
		...
		<div class="gallery__box">
			<div class="programs__box-titles">
				<h2>GALERIA <span>DE</span> IMAGENES</h2>
			</div>
			<div class="gallery__container">
			<?php
			include_once "../php/conexion.php";
			$con = mysqli_connect($host, $user, $pwd, $db);
			$query = "SELECT nombre,tipo,foto FROM tb_galeria;";
			$res = mysqli_query($con, $query);
			while ($row = mysqli_fetch_assoc($res)) {
				?>
				<img src="data:<?php echo $row['tipo']; ?>;base64,<?php echo  base64_encode($row['foto']); ?>" class="gallery__img">
				<?php
			}
			?>
			</div> 
	...
	<!-- INICIO | Modal -->
	<div class="modal__box" id="modal__box">
