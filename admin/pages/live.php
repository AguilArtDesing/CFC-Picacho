...
<body>
	...
	<div class="sidebar">
		...
		<div class="sidebar__nav-ref">
			<div class="nav__ref-box">
				...
				<div class="ref__box-option"><a href="#" class="option" title="Live Youtube"><i class="fab fa-youtube"></i></a></div>
			...
			<div class="menu__box menu__box-first">
				<div class="box__nav">
					<div class="nav__container">
						...
						<div class="nav__item"><a href="#" class="nav__link">Youtube Live</a></div>
	...
	<!-- INICIO | Insercion PHP para Link de Youtube -->
	<div class="youtube__live">
		<div class="box"></div>
	...
	<!-- FIN | Insercion PHP para Link de Youtube -->
