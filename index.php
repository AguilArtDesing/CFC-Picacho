					...
					<div class="nav__container">
						<div class="nav_item">
							...
							<div class="submenu__container">
								...
								<div class="nav_item"><a href="admin/pages/aboutme.html" class="nav__link">Misión</a></div>
								<div class="nav_item"><a href="admin/pages/aboutme.html" class="nav__link">Visión</a></div>
		...
		<div class="slider__box" id="slider">
			<div class="slider__section">
				...
				<div class="slider__section-content">
					...
					<div class="section__content">
						<h2>Un solo día en tus atrios</h2>
						<h3>¡Es mejor que mil en cualquier otro lugar!</h3>
						<h4>SALMOS 81:10</h4><p></p>
						<div><a href="https://wa.me/573167438852/?text=Que%20sea%20Dios%20Bendiciendo%20su%20Vida%20Pastor%20Ivan.%20Deseo%20asistir%20a%20la%20iglesia,%20¿Me%20facilita%20información?" target="_blank"><button>¡ASISTE!</button></a></div>
					</div>
				</div>
			</div>
			<div class="slider__section">
			...
			<div class="slider__section">
				...
				<div class="slider__section-content">
					<div class="box"></div>
					<div class="section__content">
						<h2>"Cree en el Señor</h2>
						<h3>Jesucristo, y se salvarán tú y tu familia</h3>
						<h4>HECHOS 16:31</h4>
	...
	<div class="footer">
		...
		<div class="footer__container">
			...
			<div class="footer__box footer__box-right">
				...
				<h3><i class="fas fa-map-marker-alt"></i> <a href="admin/pages/contact.php">Nuestra Ubicación</a></h3>
